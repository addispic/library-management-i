              ...
              <div className="bg-white flex gap-x-1.5">
                <div className="border-r border-neutral-200">
                  <div className="w-[120px] aspect-square rounded-sm overflow-hidden">
                    <GetBookDetails _id={borrowDetailItem.book} flag="img" />
                  </div>
                  <div className="px-1.5 pb-1.5">
                    <p>
                      <GetBookDetails _id={borrowDetailItem.book} flag="tit" />
                    </p>
                    ...
                    <p className="text-xs text-neutral-500">
                      <GetBookDetails _id={borrowDetailItem.book} flag="cat" />(
                      <span>category</span>)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex-1 text-sm text-neutral-700 p-1.5 flex flex-col justify-between gap-y-1.5">
                  <p>
                    <GetBookDetails _id={borrowDetailItem.book} flag="des" />
                  </p>
                  {/* footer */}
                  <footer>
                    <div className="flex items-center gap-x-1.5">
                      <div className="w-[32px] aspect-square rounded-full overflow-hidden">
                        <GetProfile _id={borrowDetailItem.user} flag="pro" />
                      </div>
                      <div>
                        <p>
